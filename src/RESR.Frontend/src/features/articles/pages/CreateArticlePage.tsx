import { Box, Card, CardBody, Grid, GridItem, Heading, ListItem, Stack, Text, UnorderedList } from "@chakra-ui/react";
...
export function CreateArticlePage() {
  return (
    <SiteLayout headerVariant="authenticated">
      <Grid alignItems="start" gap={{ base: 8, lg: 10, xl: 12 }} templateColumns={{ base: "1fr", xl: "0.85fr 1.15fr" }}>
        <GridItem>
          <Stack spacing={6}>
            <Box>
              ...
              <CardBody p={{ base: 6, md: 7 }}>
                <Stack spacing={4}>
                  ...
                  <UnorderedList color="ink.500" fontSize={{ base: "15px", md: "16px" }} lineHeight="1.7" pl={5} spacing={2}>
                    ...
                    <ListItem>La visibilité privée permet de préparer un contenu sans exposition publique.</ListItem>
                  </UnorderedList>
                </Stack>
              </CardBody>
            </Card>
